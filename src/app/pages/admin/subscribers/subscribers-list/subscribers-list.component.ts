...
export class SubscribersListComponent implements OnInit {
  ...
  async GetSubscribers(offset: number = 0) {
    if (this.search){
    ...
    this.http.get(`${this.global_properties.BASE_YRL}/api/admin/subscribers/?search=${this.search}&active_filter=${this.active_filter}&offset=${offset}&limit=${this.global_properties.PAGINATION_NUMBER}`,{
      headers: this.global_properties.headers
    })
      .toPromise()
      .then(c => {
        // @ts-ignore
        this.subscribers = c['data'];
        // @ts-ignore
  ...
  DeleteUser(id: number) {
    ...
    this.http.delete(`${this.global_properties.BASE_YRL}/api/admin/subscribers/${id}/`,{
      headers: this.global_properties.headers
    })
      .toPromise()
      .then(c => {
  ...
  Get(id: number) {
    ...
    this.http.get(`${this.global_properties.BASE_YRL}/api/admin/subscribers/${id}`,{
      headers: this.global_properties.headers
    })
      .toPromise()
      .then(c => {
