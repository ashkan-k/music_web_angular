...
@Component({
  selector: 'singer-modal-form',
  templateUrl: './singer-modal.component.html',
  styleUrls: ['./singer-modal.component.css']
})
export class SingerModalComponent implements OnInit {
  loading = false;
  @Input() data: any | null = {};
  image: File | any = null;
  current_file: String = "";
  ...
  Submit() {
    ...
    this.current_file =  this.data['image'];
    ...
    this.data['image'] = this.current_file;
  }

  Create(formData: FormData) {

    this.http.post(`${this.global_properties.BASE_YRL}/api/admin/singers/`, formData,{
  ...
  Update(id: number , formData: FormData) {
    ...
    this.http.post(`${this.global_properties.BASE_YRL}/api/admin/singers/${id}/`, formData,{
      headers: this.user_service.headers
    })
      .toPromise()
      .then(c => {
