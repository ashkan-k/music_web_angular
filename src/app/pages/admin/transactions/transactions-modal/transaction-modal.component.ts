...
@Component({
  selector: 'transaction-modal-form',
...
export class TransactionModalComponent implements OnInit {
  ...
  Create(formData: FormData) {
    ...
    this.http.post(`${this.global_properties.BASE_YRL}/api/admin/settings/`, formData,{
  ...
  Update(id: number , formData: FormData) {
    ...
    this.http.post(`${this.global_properties.BASE_YRL}/api/admin/settings/${id}/`, formData,{
      headers: this.user_service.headers
    })
      .toPromise()
      .then(c => {
