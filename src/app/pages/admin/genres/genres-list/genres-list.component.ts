...
export class GenresListComponent implements OnInit {
  ...
  async GetGenres(offset: number = 0) {
    if (this.search){
    ...
    this.http.get(`${this.global_properties.BASE_YRL}/api/admin/genres/?search=${this.search}&offset=${offset}&limit=${this.global_properties.PAGINATION_NUMBER}`,{
  ...
  DeleteUser(id: number) {
    ...
    this.http.delete(`${this.global_properties.BASE_YRL}/api/admin/genres/${id}/`,{
      headers: this.global_properties.headers
    })
      .toPromise()
      .then(c => {
  ...
  Get(id: number) {
    ...
    this.http.get(`${this.global_properties.BASE_YRL}/api/admin/genres/${id}`,{
      headers: this.global_properties.headers
    })
      .toPromise()
      .then(c => {
